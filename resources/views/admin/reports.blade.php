...
<div class="page-header">
    ...
    @if(request('start_month') && request('end_month'))
        <a href="{{ route('admin.reports.export_pdf', ['start_month' => request('start_month'), 'end_month' => request('end_month')]) }}" class="add-btn">
            <i class="fas fa-file-pdf"></i> <span class="btn-text">Download PDF</span>
        </a>
    @else
        <a href="{{ route('admin.reports.export_pdf', ['month' => request('month', now()->format('Y-m'))]) }}" class="add-btn">
            <i class="fas fa-file-pdf"></i> <span class="btn-text">Download PDF</span>
        </a>
    @endif
</div>
...
<!-- Single Month Filter -->
<form method="GET" action="{{ route('admin.reports.index') }}" class="report-filter" id="single-filter">
...
<!-- Month Range Filter -->
<form method="GET" action="{{ route('admin.reports.index') }}" class="report-filter" id="range-filter" style="display: none;">
    <div class="filter-group">
