...
<div class="container">
    ...
    <div class="section">
        <h3>👥 Who We Are</h3>
        <p>We are a passionate team of final-year software engineering students from Universiti Tun Hussein Onn Malaysia (UTHM), driven by the goal to improve community services.</p>
    </div>

    <div class="section">
        <h3>💼 What We Offer</h3>
        <ul>
            <li>🗓️ Real-time booking for futsal, takraw, and hall facilities</li>
            <li>📱 Mobile-friendly and easy-to-use interfaces</li>
            <li>📩 Instant notifications and status updates</li>
            <li>📊 Analytical dashboard for admins and staff</li>
    ...
    <div class="section">
        ...
        <div class="highlight-box">
            <p><strong>Email:</strong> support@bookingdesaraya.com</p>
            <p><strong>Phone:</strong> 012-3456789</p>
            <p><strong>Location:</strong> Pusat Komuniti Taman Desa Raya, Batu Pahat, Johor</p>
        </div>
    </div>
</div>
